...
FROM ( 
        ...
        WHERE C2.顧客番号 = S2.顧客番号
          AND S2.最終更新日 = :SDATE
          AND S2.顧客ステータス = 9
          AND P2.カード種別 not in (504, 505, 998)
          AND C2.サービス種別 = P2.サービス種別
          AND C2.会員番号 >= P2.会員番号開始
          AND C2.会員番号 <= P2.会員番号終了
)
GROUP BY ＧＯＯＰＯＮ番号
...
---------------------------------------------------------------------------------------------
                ...
                WHERE V311.会員番号 = H311.旧会員番号 
                 ...
                 AND  P311.カード種別 not in (504, 505, 998)
                 AND  H311.旧企業コード = P311.企業コード
                 AND  H311.旧会員番号 >= P311.会員番号開始
                 AND  H311.旧会員番号 <= P311.会員番号終了
---------------------------------------------------------------------------------------------
                UNION
---------------------------------------------------------------------------------------------
                SELECT
                ...
                WHERE V312.会員番号 = H312.会員番号 
                 ...
                 AND  P312.カード種別 not in (504, 505, 998)
                 AND  H312.企業コード = P312.企業コード
                 AND  H312.会員番号 >= P312.会員番号開始
                 AND  H312.会員番号 <= P312.会員番号終了
---------------------------------------------------------------------------------------------
            ) V31
    ) 
WHERE 
...
---------------------------------------------------------------------------------------------
                ...
                WHERE V411.統合元会番号   = H411.旧会員番号
                 ...
                 AND  P411.カード種別 not in (504, 505, 998)
                 AND  H411.旧企業コード = P411.企業コード
                 AND  H411.旧会員番号 >= P411.会員番号開始
                 AND  H411.旧会員番号 <= P411.会員番号終了
---------------------------------------------------------------------------------------------
                UNION
---------------------------------------------------------------------------------------------
                SELECT
                ...
                WHERE V412.統合元会番号   = H412.会員番号
                 ...
                 AND  P412.カード種別 not in (504, 505, 998)
                 AND  H412.企業コード = P412.企業コード
                 AND  H412.会員番号 >= P412.会員番号開始
                 AND  H412.会員番号 <= P412.会員番号終了
---------------------------------------------------------------------------------------------
            ) V41
    ) 
WHERE 
...
---------------------------------------------------------------------------------------------
                ...
                WHERE V511.統合元会番号 = H511.旧会員番号 
                  ...
                  AND P511.カード種別 not in (504, 505, 998)
                  AND H511.旧企業コード = P511.企業コード
                  AND H511.旧会員番号 >= P511.会員番号開始
                  AND H511.旧会員番号 <= P511.会員番号終了
---------------------------------------------------------------------------------------------
                UNION
---------------------------------------------------------------------------------------------
                SELECT
                ...
                WHERE V512.統合元会番号 = H512.会員番号 
                  ...
                  AND P512.カード種別 not in (504, 505, 998)
                  AND H512.企業コード = P512.企業コード
                  AND H512.会員番号 >= P512.会員番号開始
                  AND H512.会員番号 <= P512.会員番号終了
            ) V51
    ) 
WHERE
     G_ROW = 1
...
---------------------------------------------------------------------------------------------
                ...
                WHERE V611.統合元会番号 =  H611.旧会員番号
                 ...
                 AND  P611.カード種別 not in (504, 505, 998)
                 AND  H611.旧企業コード = P611.企業コード
                 AND  H611.旧会員番号 >= P611.会員番号開始
                 AND  H611.旧会員番号 <= P611.会員番号終了
---------------------------------------------------------------------------------------------
                UNION
---------------------------------------------------------------------------------------------
                SELECT
                ...
                WHERE V612.統合元会番号 = H612.会員番号
                 ...
                 AND  P612.カード種別 not in (504, 505, 998)
                 AND  H612.企業コード = P612.企業コード
                 AND  H612.会員番号 >= P612.会員番号開始
                 AND  H612.会員番号 <= P612.会員番号終了
---------------------------------------------------------------------------------------------
            ) V61
    ) 
WHERE 
...
---------------------------------------------------------------------------------------------
                ...
                WHERE V711.統合元会番号 =  H711.旧会員番号
                 ...
                 AND  P711.カード種別 not in (504, 505, 998)
                 AND  H711.旧企業コード = P711.企業コード
                 AND  H711.旧会員番号 >= P711.会員番号開始
                 AND  H711.旧会員番号 <= P711.会員番号終了
---------------------------------------------------------------------------------------------
                UNION
---------------------------------------------------------------------------------------------
                SELECT
                ...
                WHERE V712.統合元会番号 = H712.会員番号
                 ...
                 AND  P712.カード種別 not in (504, 505, 998)
                 AND  H712.企業コード = P712.企業コード
                 AND  H712.会員番号 >= P712.会員番号開始
                 AND  H712.会員番号 <= P712.会員番号終了
---------------------------------------------------------------------------------------------
            ) V71
    ) 
WHERE
