...
SELECT
    ...
    RPAD(TBLA.注文種別,LENGTH(TBLA.注文種別)) ,',',
    RPAD(TBLA.店頭受取注文企業コード,LENGTH(TBLA.店頭受取注文企業コード)) ,',',
    RPAD(TBLA.店頭受取注文店舗コード,LENGTH(TBLA.店頭受取注文店舗コード)) ,',', NULL)
FROM
      WS購買履歴 TBLA
    LEFT JOIN WS会員ＧＯＯＰＯＮ番号 TBLC
